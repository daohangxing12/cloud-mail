<template>
  <div class="email-container" :class="{ 'compact-layout': compactLayout }">
      ...
      <UseVirtualList ref="scrollbarRef"
        ...
        >
          <template #default="{ data: item, index }" >
            <div :class="['email-row', props.type, { 'is-selected': props.selectedEmailId === item.emailId }]"
...
const itemHeight = computed(() => {
    if (props.compactLayout) {
      return props.type === 'all-email' ? 96 : 76;
    }
...
.email-container.compact-layout {
