...
const requirePerms = [
	...
	'/asset/list',
	'/asset/update',
	'/asset/creatorRewards/scanHistory',
	'/asset/tiktok/scanInbox',
	'/role/add',
	'/role/list',
	'/role/delete',
	'/role/tree',
...
const premKey = {
	...
	'user:query': ['/user/list','/user/allAccount', '/subAccount/list', '/subAccount/token', '/asset/list'],
	'user:add': ['/user/add', '/subAccount/add', '/subAccount/import'],
	'user:reset-send': ['/user/resetSendCount'],
	'user:set-pwd': ['/user/setPwd'],
	'user:set-status': ['/user/setStatus', '/user/restore', '/subAccount/setName', '/subAccount/setTiktok', '/subAccount/genToken', '/asset/update', '/asset/batchStatus', '/asset/creatorRewards/scanHistory', '/asset/tiktok/scanInbox'],
	'user:set-type': ['/user/setType'],
	'user:delete': ['/user/delete','/user/deleteAccount', '/subAccount/delete'],
	'all-email:query': ['/allEmail/list','/allEmail/latest'],
	'all-email:delete': ['/allEmail/delete','/allEmail/batchDelete'],
	'setting:query': ['/setting/query'],
	'setting:set': ['/setting/set', '/setting/setBackground','/setting/deleteBackground','/setting/setBlacklist', '/email/blockSender'],
	'analysis:query': ['/analysis/echarts', '/asset/summary'],
